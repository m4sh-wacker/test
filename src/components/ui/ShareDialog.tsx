    ...
    >
      ...
      <div className="mt-4">
        ...
        <textarea
          ...
          className="w-full resize-none rounded-control border border-line bg-surface-2 p-2.5 font-mono text-micro leading-relaxed outline-none focus:border-accent-line"
        />
